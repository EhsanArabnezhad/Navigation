...
<img src="assets/best-agent.png" width="50%" align="top-left" alt="" title="Best Agent Graph" />
<img src="assets/plot.png" width="50%" align="top-left" alt="" title="Performance Plot" />
...
## Future Improvements
- **Test the replay buffer** &mdash; Implement a way to enable/disable the replay buffer.
- **Add *prioritized* experience replay** &mdash; Rather than selecting experience tuples randomly.
- **Replace conventional exploration heuristics with Noisy DQN** 
